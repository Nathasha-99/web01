...
const ClinicCareInformationForm = () => {
  const [userRole, setUserRole] = useState("MOH doctor"); // Set default user role
        ...
        <Grid container spacing={2}   sx={{ width: "90%" }}>
            ...
            <Grid item xs={12} sx={{ padding: "1em 1em 0em 1em !important" }}>
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                    ...
                    <DateField label="Visit Date" required sx={{ width: "100%" }} disabled={userRole !== "midwife"}/>
                    </DemoContainer>
            ...
            <Grid item xs={6} sx={{ padding: "1em 1em 0em 1em !important" }}>
                ...
                // Enable editability only for midwives
            ...
            <Grid container spacing={1} item xs={12} mt={1} sx={{ padding: "1em 1em 0em 1em !important" }}>
                ...
                <Grid item xs={6} sx={{ padding: "1em 1em 0em 1em !important" }}>
                    ...
                    <RadioInputGroup label="Ankle" options={radioGroupOptions}  required disabled={userRole !== "MOH doctor"} />
                    <RadioInputGroup label="Facial" options={radioGroupOptions}  required disabled={userRole !== "MOH doctor"} />
                    {/* Enable editability only for MOH doctor */}
                </Grid>  

                <Grid item xs={6} sx={{ padding: "1em 1em 0em 1em !important" }}>
                    <RadioInputGroup label="Pallor" options={radioGroupOptions} required disabled={userRole !== "MOH doctor"} />
                    {/* Enable editability only for MOH doctor */}
                </Grid> 
            ...
            <Grid item xs={6} sx={{ padding: "1em 1em 0em 1em !important" }}>
                <RadioInputGroup label="FM" options={radioGroupOptions} disabled={userRole !== "MOH doctor"} />
            </Grid>

            <Grid item xs={6} sx={{ padding: "1em 1em 0em 1em !important" }}>
                <RadioInputGroup label="FHS" options={radioGroupOptions} disabled={userRole !== "MOH doctor"} />
            </Grid>
            ...
            <Grid item xs={6} sx={{ padding: "1em 1em 0em 1em !important" }}>
                ...
                <Grid item xs={6} sx={{ padding: "1em 1em 0em 1em !important" }}>
                    <FormControl fullWidth>
                        <InputLabel id="examined-officer-label">Examined Officer Designation</InputLabel>
                            <Select
                            required
                            labelId="examined-officer-label"
                            id="examined-officer-select"
                            //value={formData.ExaminedOfficerDesignation}
                            onChange={handleInputChange}
                            sx={{ width: "100%" }}
                            >
                                <MenuItem value="mohDoctor">MOH Doctor</MenuItem>
                                <MenuItem value="miwife">Midwife</MenuItem>
                            </Select>
                    </FormControl>
                </Grid>
